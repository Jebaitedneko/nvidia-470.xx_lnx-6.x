 ...
 *
 * Copyright 2013-2020 by NVIDIA Corporation.  All rights reserved.  All
                                     ...
                                     const UvmPmaStatistics **pPmaPubStats)
{
    ...
    status = rm_gpu_ops_get_pma_object(sp, (gpuAddressSpaceHandle)vaSpace, pPma, (const nvgpuPmaStatistics_t *)pPmaPubStats);
                                             ...
                                             UvmGpuCopyEnginesCaps *caps)
{
    ...
    status = rm_gpu_ops_query_ces_caps(sp, (gpuAddressSpaceHandle)vaSpace, caps);
                                   ...
                                   UvmGpuEccInfo * eccInfo)
{
    ...
    status = rm_gpu_ops_get_ecc_info(sp, (gpuAddressSpaceHandle)vaSpace, eccInfo);
                                                 ...
                                                 const void *pFaultPacket)
{
    ...
    status = rm_gpu_ops_report_non_replayable_fault(sp, (gpuAddressSpaceHandle)vaSpace, pFaultPacket);
