...
NVIDIA_UVM_SOURCES += nvidia-uvm/uvm_kepler.c
NVIDIA_UVM_SOURCES += nvidia-uvm/uvm_kepler_ce.c
NVIDIA_UVM_SOURCES += nvidia-uvm/uvm_kepler_host.c
NVIDIA_UVM_SOURCES += nvidia-uvm/uvm_kepler_mmu.c
NVIDIA_UVM_SOURCES += nvidia-uvm/uvm_kepler_fault_buffer.c
NVIDIA_UVM_SOURCES += nvidia-uvm/uvm_kepler_access_counter_buffer.c
...
NVIDIA_UVM_SOURCES += nvidia-uvm/uvm_mmu_test.c
